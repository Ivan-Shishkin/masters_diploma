...
(x_noise, intervals_x), (y_noise, intervals_y) = model_2.uni_normal_noise(min_x, max_x, step_x, 0, 1, 0, 1)
...
writer = pd.ExcelWriter('../data/two_dimensional_equal_true_errs.xlsx', engine='xlsxwriter')
