...
intervals_x = np.ones(x_noise.shape[0])*1.
...
intervals_y = np.ones(y_noise.shape[0])*0.9
...
writer = pd.ExcelWriter('../data/reconstruction_report_two_dim_eq_impossible.xlsx', engine='xlsxwriter')
